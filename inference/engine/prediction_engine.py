"""
Streamlined prediction engine debug visualization
"""
...
class PredictionEngine:
    ...
    def __init__(self, model_path: str, debug_dir: str = "debug"):
    ...
    def predict(
        ...
        """Make prediction with simplified debug visualization in specific order"""
        ...
        # Create simplified debug visualization in requested order
        debug_path = self._create_ordered_debug_viz(
            stroke_input, image_input, raw_strokes, optimized_points, canvas, results
        )
